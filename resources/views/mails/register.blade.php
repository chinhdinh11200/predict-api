                        ...
                        <tbody>
                            <tr>
                                <td style="padding-top:5px;padding-bottom:15px">
                                    {{ trans('mail.greet') }}
                                    <span style="color:#021744;font-weight:bold;font-size:16px">{{ $username }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top:5px;padding-bottom:5px">
                                    {{ trans('mail.register.thank') }}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top:5px;padding-bottom:5px">
                                    {{ trans('mail.register.confirm') }}
                                </td>
                            </tr>
                            <tr>
